...
class JoyTeleop(Node):
	...
	def user_jetson(self, joy_data):
		#cancel nav
		if joy_data.buttons[12] == 1: self.cancel_nav()
        #linear Gear control +
		...
		if joy_data.buttons[6] == 1:
			if self.linear_Gear == 1.0: self.linear_Gear = 2.0 / 3
			elif self.linear_Gear == 2.0 / 3: self.linear_Gear = 1.0 / 3
			elif self.linear_Gear == 1.0 / 3: self.linear_Gear = 1
