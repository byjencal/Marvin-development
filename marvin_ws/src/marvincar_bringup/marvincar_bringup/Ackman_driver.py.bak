...
class marvincar_driver(Node):
    def __init__(self, name):
        ...
        self.MAX_LINEAR_SPEED = 1.8   
        self.UPDATE_RATE = 0.05       # 20 Hz
        
        self.ACCEL_STEP = 0.6 * self.UPDATE_RATE
        self.COAST_STEP = 0.2 * self.UPDATE_RATE
        self.BRAKE_STEP = 1.8 * self.UPDATE_RATE
...
def main():
    rclpy.init() 
    driver = marvincar_driver('driver_node')
    rclpy.spin(driver)
