...
class MarvinStereoCamera(Node):
    def __init__(self):
        ...
        # Publicadores comprimidos para salvar el ancho de banda del Wi-Fi
        ...
        # Frecuencia de publicación (~30 FPS de lectura)
        ...
        self.get_logger().info('Inicializando cámaras IMX219 con compresión JPEG...')
    ...
    def gstreamer_pipeline(self, sensor_id, width=1280, height=720, framerate=60):
        # Obligamos a la Jetson a usar el modo de 60fps (sensor-mode=4) y descartar frames viejos
        return (
    ...
    def timer_callback(self):
        ...
        # Convertir a formato JPEG de ROS 2 y publicar
        if ret_l:
